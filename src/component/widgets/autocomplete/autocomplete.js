define(function (require, exports) {
    ...
    var Autocomplete = function (options) {
        $.extend(this, options, Autocomplete.defaultOptions);
    ...
    Autocomplete.prototype.initStructure = function () {
    ...
    Autocomplete.prototype.render = function (data) {
        var html = Simplite.render('autocomplete-template', data || []);
        var offset = this.element.offset();
        this.autoConatinerNode.html(html).show().find('.dropdown-menu').css({
